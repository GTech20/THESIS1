            ...
            <div class="modal-body">
                <div class="form-group">
                    <form class="form-horizontal" method="POST" action="purchase_add.php">
                        ...
                        <div class="form-group">
                            <label for="client" class="col-sm-3 control-label">First Name</label>
                            </br>
                            <div class="col-12">
                        ...
                        <div class="form-group">
                            <label for="client" class="col-sm-3 control-label">Last Name</label>
                            </br>
                            <div class="col-12">
                                <input type="text" class="form-control" style="color: black;" id="client_name" name="client" placeholder="Enter Name..." required>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="client" class="col-sm-3 control-label">Age</label>
                            </br>
                            <div class="col-12">
                        ...
                        <div class="form-group">
                            <label for="client" class="col-sm-3 control-label">Contact No.</label>
                            </br>
                            <div class="col-12">
