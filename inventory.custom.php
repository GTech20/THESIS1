...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Custom Made Materials</h1>
                        <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#custmaterialModal">
                                                ...
                                                <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <center>
                                                                    <a href="#" class="btn btn-info btn-circle" data-toggle="modal" data-target="#updateRaw">
            ...
            <?php require 'includes/custom.materials.modal.php';?>
